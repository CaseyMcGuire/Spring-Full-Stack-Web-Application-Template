...
Before planning or editing, read the rules relevant to the task:

- Frontend, including Vite and Relay: [frontend rules](.agents/rules/frontend.md).
- Backend, including EntKt, migrations, and GraphQL schemas: [backend rules](.agents/rules/backend.md).
- Tasks involving both, including shared GraphQL schemas, SPA routes, or HTML asset rendering: read both files.
...
- Never hand-edit generated files; follow the relevant rule file for regeneration and committed outputs.
